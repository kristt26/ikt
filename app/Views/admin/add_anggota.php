            ...
            <div class="card-body">
                <form ng-submit="save()">
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control form-control-sm" ng-model="datas.kk" readonly>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                    ...
                    <div class="row">
                        ...
                        <div class="col">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control form-control-sm" name="pendeta" id="pendeta" ng-model="baptis.pendeta" placeholder="Nama Pendeta">
                            </div>
                        </div>
                        <div class="col">
                            <div class="form-group">
                    ...
                    <div class="row">
                        ...
                        <div class="col">
                            <div class="form-group">
                                <label for="pendeta_sidi">Pendeta &nbsp;</label>
                                <input type="text" class="form-control form-control-sm" name="pendeta_sidi" id="pendeta_sidi" ng-model="sidi.pendeta" placeholder="Nama Pendeta">
                            </div>
                        </div>
                        <div class="col">
                            <div class="form-group">
                    ...
                    <div class="row" ng-if="model.status_kawin && model.status_kawin == 'Kawin'">
                        ...
                        <div class="col">
                            <div class="form-group">
                                <label for="pendeta_nikah">Pendeta &nbsp;</label>
                                <input type="text" class="form-control form-control-sm" name="pendeta_nikah" id="pendeta_nikah" ng-model="nikah.pendeta" placeholder="Nama Pendeta">
                            </div>
                        </div>
                        <div class="col">
                            <div class="form-group">
